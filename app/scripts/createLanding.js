  ...
  destroy = {
    ...
    setShadowDom: function() {
      ...
      if (!document.getElementById('standup-overlay')) {
        ...
        return shadow.innerHTML = that.content;
      }
    },
    init: function() {
      return this.setShadowDom();
